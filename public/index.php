<?php
/**
 * Front controller — CodeIgniter 3, adaptado para servir a partir de public/
 * com application/, system/ e vendor/ fora do webroot.
 */
...
// Composer autoload (bibliotecas como endroid/qr-code) dentro do CI3 clássico.
