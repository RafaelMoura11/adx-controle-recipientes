<h1 class="h3 mb-4">Relatório de devoluções por motorista</h1>
...
<div class="card">
	<div class="table-responsive">
		<table class="table table-sm mb-0 align-middle">
			...
			<?php endforeach; ?>
			<?php if (empty($linhas)): ?>
				<tr><td colspan="4" class="text-center text-muted py-4">Nenhuma devolução no período selecionado.</td></tr>
			<?php endif; ?>
			</tbody>
		</table>
	</div>
