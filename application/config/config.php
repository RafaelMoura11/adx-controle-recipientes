...
$config['base_url'] = isset($_SERVER['HTTP_HOST']) ? $protocol.'://'.$_SERVER['HTTP_HOST'].'/' : 'http://localhost:8080/';
...
|
*/
$config['encryption_key'] = getenv('CI_ENCRYPTION_KEY') ?: 'adx-desafio-troque-esta-chave-em-producao';
